            ...
            <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="text-muted font-weight-normal">Tất cả công</h6>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="text-muted font-weight-normal">Số công tháng này</h6>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="text-muted font-weight-normal">Số ngày nghỉ</h6>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="text-muted font-weight-normal">Số lần đi muộn</h6>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <form class="forms-sample" method="POST"
                                    ...
                                    <div class="template-demo @error('avatar') is-invalid @enderror">
                                        ...
                                        <button type="button" class="btn btn-outline-danger btn-icon-text"
                                            ...
                                            <i class="mdi mdi-upload btn-icon-prepend"></i> Chọn ảnh </button>
                                        <button type="submit" class="btn btn-outline-primary btn-icon-text">
                                            <i class="mdi mdi-file-check btn-icon-prepend"></i> Lưu </button>
                                    </div>
                                    @error('avatar')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-row justify-content-between">
                            <h4 class="card-title mb-1">Thông tin cá nhân</h4>
